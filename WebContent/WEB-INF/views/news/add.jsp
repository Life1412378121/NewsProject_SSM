	    ...
	    <form id="add-form" method="post">
	    	<table cellpadding="5">
	    		...
	    		<tr>
	    			<td>新闻封面:</td>
	    			<td>
	    				<input class="wu-text easyui-textbox easyui-validatebox" type="text" id="add-photo" name="photo" value="请输入图片链接或者本地上传" data-options="required:true,missingMessage:'请上传封面'"></input>
