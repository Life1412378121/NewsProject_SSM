	    ...
	    <form id="edit-form" method="post">
	    	...
	    	<table cellpadding="5">
	    		...
	    		<tr>
	    			<td>新闻封面:</td>
	    			<td>
	    				<input class="wu-text easyui-textbox easyui-validatebox" type="text" id="edit-photo" name="photo" value="${news.photo }" data-options="required:true,missingMessage:'请上传封面'"></input>
