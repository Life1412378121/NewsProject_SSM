...
<%@ include file="../common/header_app.jsp" %>
  ...
  <header class="article-header">
	...
	<div class="article-meta"> 
		<span class="item article-meta-time">
	  	...
	  	<span class="item article-meta-source" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="来源：【智慧消费新闻】">
	  		<i class="glyphicon glyphicon-globe"></i> 
	  		智慧消费新闻博客
	  	</span> 
	  	<span class="item article-meta-category" data-toggle="tooltip" data-placement="bottom" title="${news.title }" data-original-title="分类：${news.newsCategory.name }">
...
$(document).ready(function(){
	...
	$("#collect").click(function(){
		...
		//异步加载评论内容
		$.ajax({
			url:'../index/saveCollect',
			type:'post',
			data:{userId:'${account.id}',newsId:'${news.id}'},
			dataType:'json',
			success:function(data){
				if(data.type == 'success'){
					alert("收藏成功!");
