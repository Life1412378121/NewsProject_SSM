...
<div class="container">
  <div class="header-topbar hidden-xs link-border">
		...
		<c:if test="${account != null }">
		<ul class="site-nav topmenu">
		  	<li>欢迎 [${account.name }]</li>
			<li><a href="../index/center" >个人中心</a></li>
		</ul>
		
		</c:if>
	
	最新新闻，最新资讯，你想知道的，都在这里</div>
  <div class="navbar-header">
	<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#header-navbar" aria-expanded="false"> <span class="sr-only"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
	<h1 class="logo hvr-bounce-in"><a href="../index/index" title="智慧消防新闻博客网站"><img src="../resources/home/images/logo.png" alt="智慧消防新闻博客网站"></a></h1>
  </div>
  <div class="collapse navbar-collapse" id="header-navbar">
	...
	<ul class="nav navbar-nav navbar-right">
	  <li><a data-cont="智慧消防新闻博客网站" title="智慧消防新闻博客网站" href="../index/index">首页</a></li>
